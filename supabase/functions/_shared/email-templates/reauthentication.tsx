      ...
      <Container style={wrapper}>
        ...
        <Container style={container}>
          <Section style={logoSection}>
            <Img src="https://faqlafabgmlfxnyyvznq.supabase.co/storage/v1/object/public/email-assets/logo.png" alt="FACAM PERFORMER" width="220" height="auto" style={{ margin: '0 auto 0 calc(50% - 120px)', display: 'block' }} />
          </Section>
          ...
          <Text style={footerBrand}>© {new Date().getFullYear()} PerformX — Tous droits réservés</Text>
        </Container>
      </Container>
    </Body>
  </Html>
