    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Container style={container}>
          ...
          <Text style={text}>Nous avons reçu une demande de réinitialisation de votre mot de passe pour <strong style={{ color: '#f0e6d2' }}>{siteName}</strong>.</Text>
          ...
          <Section style={warningBox}>
            <Text style={warningText}>⏳ Ce lien expirera dans 15 minutes pour des raisons de sécurité.</Text>
          </Section>

          <Hr style={divider} />
          <Text style={footer}>Si vous n'avez pas demandé cette réinitialisation, vous pouvez ignorer cet email. Votre mot de passe ne sera pas modifié.</Text>
