    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Container style={container}>
          ...
          <Heading style={h1}>Bonjour <span style={highlight}>{firstName || 'cher collaborateur'}</span> 👋</Heading>
          <Text style={text}>Bienvenue sur <strong style={highlight}>{siteName}</strong> ! Votre compte a été créé avec succès.</Text>
          ...
          <Hr style={divider} />
          <Text style={footer}>Si vous n'êtes pas à l'origine de cette inscription, vous pouvez ignorer cet email.</Text>
