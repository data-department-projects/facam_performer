...
export const InviteEmail = ({ siteName, confirmationUrl, firstName }: InviteEmailProps) => (
    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Container style={container}>
          ...
          <Text style={text}>
            Vous êtes invité à rejoindre la plateforme de gestion{' '}
            <span style={highlight}>{siteName}</span>.
          </Text>
...
const highlight = { color: '#d4a843', fontWeight: '700' as const }
